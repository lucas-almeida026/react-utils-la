declare type JustifyContent = 'flex-start' | 'center' | 'flex-end' | 'space-evenly' | 'space-around' | 'space-between';
declare type AlignItems = 'flex-start' | 'center' | 'flex-end';
export declare const stackFlexColumn: (horizontalAlignment?: AlignItems, verticalAlginment?: JustifyContent) => any;
